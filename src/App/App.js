...
import NftStake from "pages/Nft/NftStake";
...
const ethWsProvider = new ethers.providers.JsonRpcProvider("https://ethereum-goerli.publicnode.com");
    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>, and use $SEVEN with its built-in
              browser
            </Trans>
          ) : (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink> to start using $SEVEN
            </Trans>
          )}
        </div>
      );
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>, and use SEVEN
