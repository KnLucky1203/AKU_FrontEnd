...
export function RedirectPopupModal({
  ...
  return (
    <Modal
      ...
      label={t`Launch App`}
    >
      <Trans>You are leaving $SEVEN.io and will be redirected to a third party, independent website.</Trans>
      <br />
      <br />
      <Trans>
        The website is a community deployed and maintained instance of the open source{" "}
        <ExternalLink href="https://github.com/SEVEN/">$SEVEN front end</ExternalLink>, hosted and served on the
        distributed, peer-to-peer <ExternalLink href="https://ipfs.io/">IPFS network</ExternalLink>.
      </Trans>
      <br />
      <br />
      <Trans>
        Alternative links can be found in the <ExternalLink href="https://docs.SEVEN.financeapp-links">docs</ExternalLink>
        .
        <br />
        <br />
        By clicking Agree you accept the <ExternalLink href="/terms-and-conditions">T&Cs</ExternalLink> and{" "}
