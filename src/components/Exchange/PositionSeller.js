...
import { AVALANCHE, getChainName, getConstant, IS_NETWORK_DISABLED } from "config/chains";
        ...
        return (
          <div className="Confirmation-box-warning">
            <Trans>
              ...
              <ExternalLink href="https://docs.SEVEN.financetrading#minimum-price-change">
                pending profit
      ...
      return (
        <div className="Confirmation-box-warning">
          <Trans>
            ...
            <ExternalLink href="https://docs.SEVEN.financetrading#minimum-price-change">profit</ExternalLink> of{" "}
            {deltaStr}. <br />
          </Trans>
          <Trans>
            Profit price: {position.isLong ? ">" : "<"} ${formatAmount(profitPrice, USD_DECIMALS, 2, true)}. This rule
                  ...
                  renderContent={() => (
                    <div>
                      ...
                      <div className="PositionSeller-fee-item">
                        <Trans>
                          <ExternalLink href="https://docs.SEVEN.financetrading#fees">More Info</ExternalLink> about fees.
                        </Trans>
                      </div>
                    </div>
                  )}
