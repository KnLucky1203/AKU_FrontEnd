...
import { AVALANCHE, getChainName, getConstant, IS_NETWORK_DISABLED, isSupportedChain } from "config/chains";
...
export default function SwapBox(props) {
  ...
  const getLeaderboardLink = () => {
    if (chainId === AVALANCHE) {
      return "https://www.gmx.house/goerli/leaderboard";
    }
  ...
  const increasePosition = async () => {
    ...
    callContract(chainId, contract, method, params, {
      ...
      successMsg,
      // for Avalanche, sometimes the successMsg shows after the position has already been executed
      // hide the success message for Avalanche as a workaround
      hideSuccessMsg: chainId === AVALANCHE,
    })
      .then(async () => {
        setIsConfirming(false);
        ...
        {isStopOrder && (
          <div className="Exchange-swap-section Exchange-trigger-order-info">
            <Trans>
              ...
              <ExternalLink href="https://docs.SEVEN.financetrading#stop-loss-take-profit-orders">docs</ExternalLink>.
            </Trans>
          </div>
        )}
                  ...
                  return (
                    <div>
                      <Trans>
                        ...
                        <br />
                        <br />
                        <ExternalLink href="https://docs.SEVEN.financetrading#opening-a-position">More Info</ExternalLink>
                      </Trans>
                    </div>
                  );
                }}
                ...
                renderContent={() => {
                  return (
                    <div>
                      ...
                      <br />
                      <ExternalLink href="https://docs.SEVEN.financetrading#opening-a-position">
      ...
      <div className="Exchange-swap-market-box App-box App-box-border">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="https://docs.SEVEN.financetrading">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="https://docs.SEVEN.financetrading#backup-rpc-urls">
