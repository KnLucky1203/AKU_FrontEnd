...
const footerLinks = {
  home: [
    ...
    { text: t`Referral Terms`, link: "https://SEVEN.gitbook.referrals", external: true },
    { text: t`Media Kit`, link: "https://docs.SEVEN.finance", external: true },
...
const socialLinks = [
  { link: "https://twitter.com/SEVEN.finance", name: "Twitter", icon: twitterIcon },
  // { link: "https://SEVENfinance.medium.com/", name: "Medium", icon: mediumIcon },
  { link: "https://github.com/SEVEN", name: "Github", icon: githubIcon },
  { link: "https://t.me/SEVENchat", name: "Telegram", icon: telegramIcon },
