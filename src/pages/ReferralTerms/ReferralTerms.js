      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">$SEVEN Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the $SEVEN Referral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the $SEVEN DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the $SEVEN DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the $SEVEN DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, $SEVEN DApp provides you with the Links and Referral Codes necessary to promote the
                $SEVEN Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct
                Referral Code. You may promote the $SEVEN Protocol offers in any manner you choose unless it misleads
                someone about the $SEVEN Protocol.
              </p>
              <p className="body-text">
                2.2 SEVEN.finance is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the $SEVEN tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                SEVEN.finance is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and
                Discounts are handled following the directives of the $SEVEN tokenholders.
              </p>
              <p className="body-text">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://zomi.gitbook.referrals">
                  https://zomi.gitbook.referrals.
                </a>
              </p>
            </div>
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall SEVEN.finance be liable for any direct, indirect, incidental, punitive,
              ...
              <p className="body-text">
                In no event shall SEVEN.finance's aggregate liability arising out of or in connection with the Site exceed
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                service(s) provided by SEVEN.finance, or your use of the service(s) provided by SEVEN.finance, including,
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from SEVEN.finance, which the token holders of $SEVEN determine. Due
              ...
              <p className="body-text">
                SEVEN.finance will not be liable for any losses suffered by you resulting from any modification to the
              ...
              <p className="body-text">
                SEVEN.finance may revise these Terms from time to time. We will notify you by updating the date at the top
                of the Terms and maintaining a current version. The most current version of the Terms will always be at
                /referral-terms. All modifications will be effective when they are posted. By using the Referral Program
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and SEVEN.finance concerning the subject matter of these Terms and supersede
                all prior or contemporaneous agreements, representations, warranties, and understandings, written or
                oral, concerning the subject matter of these Terms. Any failure by us to exercise or enforce any right
                or provision of the Terms shall not constitute a waiver of such right or provision.
              </p>
              <p className="body-text">
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. SEVEN.finance will amend or replace such provision with one that is
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. SEVEN.finance may assign or transfer any or all of our rights
                or obligations under these Terms, in whole or part, without notice or obtaining your consent or
                approval.
              </p>
              <p className="body-text">
                8.6 SEVEN.finance will have no responsibility or liability for any failure or delay in performance of the
