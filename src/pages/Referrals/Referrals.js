        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>
                Get fee discounts and earn rebates through the $SEVEN referral program. For more information, please read
                the <ExternalLink href="https://SEVEN.gitbook.referrals">referral program details</ExternalLink>.
              </Trans>
            </div>
          </div>
        </div>
