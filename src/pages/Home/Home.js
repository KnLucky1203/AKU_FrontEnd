        ...
        <div className="Home-title-section-container default-container">
          <div className="Home-title-section">
            ...
            <div className="Home-description">
              <Trans>
                Trade ETH, BNB, MATIC and other top cryptocurrencies with up to 50x leverage directly from your wallet
              </Trans>
            </div>
        ...
        <div className="Home-latest-info-container default-container">
          ...
          <div className="Home-latest-info-block">
            ...
            <div className="Home-latest-info-content">
              ...
              <div className="Home-latest-info__value">
                {openInterest ? formatNumber(openInterest, { currency: true, compact: false }) : `$0`}
              </div>
            </div>
          </div>
          <div className="Home-latest-info-block">
