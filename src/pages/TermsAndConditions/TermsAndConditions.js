      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">$SEVEN</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to SEVEN.finance ("we," "us," or "our"), the informational resource for $SEVEN Protocol, as defined
                below.
              </p>
              <p className="body-text">
                SEVEN.finance provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the $SEVEN Protocol (the "$SEVEN Protocol," "Protocol," or "$SEVEN DApp"). SEVEN.finance is not
                an available access point to the $SEVEN Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access SEVEN.finance ("the Site") and app.SEVEN.finance ("the Interface").
            ...
            <div className="section">
              ...
              <p className="body-text">The SEVEN.finance site is for informational purposes only.</p>
              <p className="body-text">
                SEVEN.finance is not part of any transaction on the blockchain networks underlying the $SEVEN Protocol; we
                do not have possession, custody, or control over any crypto assets appearing on the Interface; and we do
                not have possession, custody, or control over any user's funds. Further, we do not store, send, or
                receive any crypto assets. You understand that when you interact with any $SEVEN Protocol smart contracts,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over SEVEN.finance or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that SEVEN.finance or any of its suppliers or contractors may undertake from
                        time to time; (c) causes beyond SEVEN.finance's control or that SEVEN.finance could not reasonably
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with SEVEN.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. SEVEN.finance does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. SEVEN.finance does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. SEVEN.finance own all rights, names, logos, and other marks used on the Site and the Interface,
                    including, without limitation, any copyrights in and to any content, code, data, or other materials
                    that you may access or use on or through the Site or the Interface; however, the code for the $SEVEN
                    Protocol and the Interface (SEVEN.finance) deployed on IPFS is open-sourced. Except as expressly set
                ...
                <li>
                  <p className="body-text">
                    4.2. SEVEN.finance may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that SEVEN.finance is free to use
                    or not use any feedback we receive from you as we see fit, including copying and sharing such
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. SEVEN.finance reserve the right, at our sole discretion, from time to time and with or without
                    prior notice to you, to modify, suspend or disable (temporarily or permanently) the Site or our
                    subdomain to the Interface, in whole or in part, for any reason whatsoever, including, without
                    limitation. Upon termination of your access, your right to use the Site or the Interface from our
                    subdomain will immediately cease. However, it would still be accessible via a third party since we
                    do not host or own its code. SEVEN.finance will not be liable for any losses suffered by you resulting
                    from any modification to the Site or the Interface or from any modification, suspension, or
                    termination, for any reason, of your access to all or any portion of the Site or the Interface.
                  </p>
                </li>
                <li>
                  <p className="body-text">
                    5.2. SEVEN.finance may revise these Terms from time to time. We will notify you by updating the date
                    at the top of the Terms and maintaining a current version. The most current version of the Terms
                    will always be at /terms-and-conditions. All modifications will be effective when they are posted.
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. SEVEN.finance does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That SEVEN.finance is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither SEVEN.finance nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. SEVEN.finance is not responsible for the content of any third party, including, but not limited
                    to, information, materials, products, or services that SEVEN.finance does not own or control. In
                    addition, third parties may offer promotions related to your access and use of the Interface.
                    SEVEN.finance does not endorse or assume any responsibility for such resources or promotions. Suppose
                    you access any such resources or participate in any such promotions. In that case, you do so at your
                    own risk and understand that these Terms do not apply to your dealings or relationships with any
                    third parties. You expressly relieve SEVEN.finance of all liability arising from using such resources
                    or participating in such promotions.
                  </p>
                </li>
                <li>
                  <p className="body-text">
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that SEVEN.finance will have no responsibility or liability for the
                    risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against SEVEN.finance, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of SEVEN.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including SEVEN.finance's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                SEVEN.finance is an informational site for the $SEVEN Protocol. SEVEN.finance does not operate an exchange
              ...
              <p className="body-text">
                You understand that SEVEN.finance is not registered or licensed by any regulatory agency or authority. No
              ...
              <p className="body-text">
                ...
                SEVEN.finance makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall SEVEN.finance, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of SEVEN.finance, whether under contract, tort
                ...
                or any limited remedy hereunder nor is SEVEN.finance in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall SEVEN.finance's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless SEVEN.finance, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                SEVEN.finance will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to SEVEN.finance on any of our official channels. The notice must (a) describe the nature
                and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar
                in form to that described above. If you and SEVEN.finance cannot reach an agreement to resolve the claim
                within sixty (60) days of your email, then you and SEVEN.finance agree to resolve the potential dispute
              ...
              <p className="body-text">
                ...
                SEVEN.finance will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of SEVEN.finance set forth in these Terms is in addition to, and not in lieu
                    of, any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of SEVEN.finance in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. SEVEN.finance will have no responsibility or liability for any failure or delay in performance
                    of the Site or the Interface, or any loss or damage that you may incur, due to any circumstance or
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and SEVEN.finance and supersede all prior
                    and contemporaneous understandings between the parties regarding the Interface and the Site or the
                    Interface.
                  </p>
                </li>
                <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                SEVEN.finance on any of our official channels.
              </p>
            </div>
          </div>
        </div>
