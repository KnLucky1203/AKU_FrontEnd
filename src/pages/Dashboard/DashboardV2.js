...
import gmx40Icon from "img/seven.png";
import glp40Icon from "img/slp.png";
...
const ACTIVE_CHAIN_IDS = [AVALANCHE];
...
export default function DashboardV2() {
  ...
  const { infoTokens: infoTokensAvalanche } = useInfoTokens(null, AVALANCHE, active, undefined, undefined);
  // const { infoTokens: infoTokensAvax } = useInfoTokens(null, AVALANCHE, active, undefined, undefined);

  const { data: currentFees } = useSWR(
    // infoTokensAvalanche[AddressZero].contractMinPrice && infoTokensAvax[AddressZero].contractMinPrice
    infoTokens[AddressZero].contractMinPrice ? "Dashboard:currentFees" : null,
    {
      fetcher: () => {
        return Promise.all(
          ...
          return fees.reduce(
            (acc, cv, i) => {
              const feeUSD = getCurrentFeesUsd(
                ...
                cv,
                infoTokens
                // ACTIVE_CHAIN_IDS[i] === AVALANCHE ? infoTokensAvalanche : infoTokensAvax
              );
  ...
  let { avax: avaxStakedGmx, avalanche: avalancheStakedGmx, total: totalStakedGmx } = useTotalGmxStaked();
  ...
  const usdtFloorPriceFund = expandDecimals(784 + 200, 30);
  ...
  if (eth && eth.contractMinPrice && glpPrice) {
    ...
    totalFloorPriceFundUsd = ethFloorPriceFundUsd.add(glpFloorPriceFundUsd).add(usdtFloorPriceFund);
  }
        ...
        renderContent={() => {
          return (
            <>
              ...
              <br />
              <div>
                <ExternalLink href="https://docs.SEVEN.finance">
  ...
  const totalStatsStartDate = chainId === AVALANCHE ? t`06 June 2023` : t`06 June 2023`;
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => (
                        <span>{t`Assets Under Management: $SEVEN staked (All chains) + $SLP pool (${chainName})`}</span>
                      )}
                    />
                  </div>
                </div>
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => <span>{t`Total value of tokens in $SLP pool (${chainName})`}</span>}
                    />
                  </div>
                </div>
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          title={t`Volume`}
                          // avalancheValue={currentVolumeInfo?.[AVALANCHE].totalVolume}
                          avalancheValue={bigNumberify(0)}
                          avaxValue={
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          // avalancheValue={positionStatsInfo?.[AVALANCHE].totalLongPositionSizes}
                          avaxValue={positionStatsInfo?.totalLongPositionSizes}
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          // avalancheValue={positionStatsInfo?.[AVALANCHE].totalShortPositionSizes}
                          avaxValue={positionStatsInfo?.totalShortPositionSizes}
                    ...
                    <div>
                      <TooltipComponent
                        ...
                        renderContent={() => (
                          <StatsTooltip
                            title={t`Fees`}
                            avalancheValue={currentFees?.[AVALANCHE]}
                ...
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      <div className="App-card-title-mark-icon">
                        <img src={gmx40Icon} alt="$SEVEN Token Icon" width="40px" />
                      </div>
                      <div className="App-card-title-mark-info">
                        <div className="App-card-title-mark-title">$SEVEN</div>
                        <div className="App-card-title-mark-subtitle">$SEVEN</div>
                      </div>
                      <div>
                  ...
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>{formatAmount(totalGmxSupply, GMX_DECIMALS, 0, true)} $SEVEN</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">
                      ...
                      <div>
                        <TooltipComponent
                          ...
                          renderContent={() => (
                            <StatsTooltip
                              title={t`Staked`}
                              avalancheValue={avalancheStakedGmx}
              ...
              <div className="App-card">
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      <div className="App-card-title-mark-icon">
                        <img src={glp40Icon} alt="glp40Icon" width="40px" />
                        {chainId === AVALANCHE ? (
