...
import avalancheIcon from "img/ic_avalanche_96.svg";
...
export default function ClaimEsGmx({ setPendingTxns }) {
  ...
  const isAvalanche = chainId === AVALANCHE;
    ...
    <div className="ClaimEsGmx Page page-layout">
      <div className="Page-title-section mt-0">
        <div className="Page-title">
          <Trans>Claim esSEVEN</Trans>
        </div>
        {!isAvalanche && (
          <div className="Page-description">
            <br />
            <Trans>Please switch your network to Avalanche.</Trans>
          </div>
        )}
        {isAvalanche && (
          <div>
            <div className="Page-description">
              <br />
              <Trans>You have {formatAmount(esGmxIouBalance, 18, 2, true)} esSEVEN (IOU) tokens.</Trans>
              <br />
              <br />
              <Trans>The address of the esSEVEN (IOU) token is {esGmxIouAddress}.</Trans>
              <br />
              <Trans>
                The esSEVEN (IOU) token is transferrable. You can add the token to your wallet and send it to another
              ...
              <br />
              <Trans>
                After claiming, the esSEVEN tokens will be airdropped to your account on the selected network within 7
                days.
              </Trans>
              <br />
              <Trans>The esSEVEN tokens can be staked or vested at any time.</Trans>
              <br />
              <Trans>
                Your esSEVEN (IOU) balance will decrease by your claim amount after claiming, this is expected behaviour.
              </Trans>
              <br />
              <Trans>
            ...
            <div className="ClaimEsGmx-vesting-options">
              ...
              >
                <div className="ClaimEsGmx-option-label">
                  <Trans>Vest with $SEVEN on Avalanche</Trans>
                </div>
                <img src={avalancheIcon} alt="Avalanche" />
              </Checkbox>
              <Checkbox
                className="avalanche btn btn-primary btn-left btn-lg"
            ...
            {!error && (
              <div className="muted">
                <Trans>
                  You can currently vest a maximum of {formatAmount(maxVestableAmount, 18, 2, true)} esSEVEN tokens at a
                  ratio of {formatAmount(currentRatio, 4, 2, true)} {stakingToken} to 1 esSEVEN.
                </Trans>
                ...
                <Trans>
                  ...
                  esSEVEN at a ratio of {formatAmount(nextRatio, 4, 2, true)} {stakingToken} to 1 esSEVEN.
                </Trans>
