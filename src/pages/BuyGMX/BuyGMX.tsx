...
export default function BuyGMX() {
  ...
  const isArbitrum = chainId === AVALANCHE;
        ...
        <div className="section-title-block">
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Buy $SEVEN on {getChainName(chainId)}</Trans>
            </div>
...
function DecentralisedExchanges({ chainId, externalLinks }) {
  ...
  return (
    <Card title={t`Buy $SEVEN from a Decentralized Exchange`}>
      <div className="App-card-content">
        {isAvalanche ? (
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy GMX from Uniswap (make sure to select Avalanche):</Trans>
            </div>
          ...
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy $SEVEN from Uniswap:</Trans>
            </div>
            <div className="buttons-group col-1">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            {/* <Trans>Buy $SEVEN using Decentralized Exchange Aggregators:</Trans> */}
          </div>
          <div className="buttons-group">
        ...
        {/* <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy $SEVEN using any token from any network:</Trans>
          </div>
          <div className="buttons-group">
            <Button href={externalLinks.bungee} imgSrc={Bungee}>
              Bungee
...
function CentralisedExchanges({ chainId, externalLinks }) {
  return (
    <Card title={t`Buy $SEVEN from centralized services`}>
      <div className="App-card-content">
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">{/* <Trans>Buy $SEVEN from centralized exchanges:</Trans> */}</div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">{/* <Trans>Buy $SEVEN using FIAT gateways:</Trans> */}</div>
