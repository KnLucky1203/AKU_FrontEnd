    ...
    <div className="StakeModal">
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        ...
        {burnAmount && burnAmount.gt(0) && rewardReductionBasisPoints && rewardReductionBasisPoints.gt(0) && (
          <div className="Modal-note">
            Unstaking will burn&nbsp;
            <a href="https://docs.SEVEN.financerewards" target="_blank" rel="noopener noreferrer">
        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          <div className="Exchange-swap-section">
            ...
            <div className="Exchange-swap-section-bottom">
              ...
              <div className="PositionEditor-token-symbol">esSEVEN</div>
            </div>
          </div>
          <div className="VesterDepositModal-info-rows">
            <div className="Exchange-info-row">
              ...
              <div className="align-right">{formatAmount(balance, 18, 2, true)} esSEVEN</div>
            </div>
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">
                    ...
                    return (
                      <div>
                        ...
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Deposited`}
                          value={`${formatAmount(vestedAmount, 18, 2, true)} esSEVEN`}
                        />
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Max Capacity`}
                          value={`${formatAmount(maxVestableAmount, 18, 2, true)} esSEVEN`}
                        />
                      </div>
                    );
                  }}
                        ...
                        {amount && nextReserveAmount.gt(maxReserveAmount) && (
                          <>
                            ...
                            <Trans>
                              ...
                              {stakeTokenLabel} to vest {formatAmount(amount, 18, 2, true)} esSEVEN.
                            </Trans>
                          </>
                        )}
                      </>
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esSEVEN tokens that have been converted to $SEVEN will remain as $SEVEN tokens.
            <br />
            <br />
            To claim $SEVEN tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
...
function CompoundModal(props) {
  ...
  const getPrimaryText = () => {
    if (isApproving) {
      return t`Approving $SEVEN...`;
    }
    if (needApproval) {
      return t`Approve $SEVEN`;
    }
    if (isCompounding) {
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const { gmxPrice, gmxPriceFromAvalanche } = useGmxPrice(
    chainId,
    { avalanche: chainId === AVALANCHE ? library : undefined },
    active
  );

  let { total: totalGmxSupply } = useTotalGmxSupply();
  let { avax: avaxGmxStaked, avalanche: avalancheGmxStaked, total: totalGmxStaked } = useTotalGmxStaked();

  const { data: gmxSupply } = useSWR([`StakeV2:gmxSupply:${active}`, chainId, gmxAddress, "balanceOf", account], {
    fetcher: contractFetcher(library, Token),
  });
  ...
  const showStakeEsGmxModal = () => {
    setIsStakeModalVisible(true);
    setStakeModalTitle(t`Stake esSEVEN`);
    setStakeModalMaxAmount(processedData.esGmxBalance);
    setStakeValue("");
    setStakingTokenSymbol("esSEVEN");
  ...
  const showGmxVesterDepositModal = () => {
    ...
    setVesterDepositTitle(t`$SEVEN Vault`);
    setVesterDepositStakeTokenLabel("staked $SEVEN + esSEVEN + Multiplier Points");
  ...
  const showGmxVesterWithdrawModal = () => {
    ...
    setVesterWithdrawTitle(t`Withdraw from $SEVEN Vault`);
  ...
  const showUnstakeGmxModal = () => {
    ...
    setUnstakeModalTitle(t`Unstake $SEVEN`);
    ...
    setUnstakeValue("");
    setUnstakingTokenSymbol("$SEVEN");
    setUnstakeMethodName("unstakeGmx");
  };

  const showUnstakeEsGmxModal = () => {
    setIsUnstakeModalVisible(true);
    setUnstakeModalTitle(t`Unstake esSEVEN`);
    ...
    setUnstakeModalReservedAmount(vestingData.gmxVesterPairAmount);
    setUnstakeValue("");
    setUnstakingTokenSymbol("esSEVEN");
        ...
        renderContent={() => {
          return (
            <Trans>
              ...
              <a href="https://docs.SEVEN.financerewards#multiplier-points" rel="noreferrer" target="_blank">
                More info
              </a>
              .
            </Trans>
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " $SEVEN";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esSEVEN";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="section-title-block">
        ...
        <div className="section-title-content">
          ...
          <div className="Page-description">
            <Trans>Stake $SEVEN and $SLP to earn rewards.</Trans>
          </div>
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">$SEVEN</div>
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} $SEVEN ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} $SEVEN ($
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} $SEVEN ($
              ...
              <div className="App-card-options">
                <Link className="App-button-option App-card-option" to="/buy_SEVEN">
          ...
          <div className="App-card">
            <div className="App-card-title">$SLP ({chainName})</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)} esSEVEN ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)} esSEVEN ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)} esSEVEN ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esSEVEN ($
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esSEVEN tokens to $SEVEN tokens.
              <br />
              Please read the{" "}
              <a href="https://docs.SEVEN.financehow-it-works/rewards" target="_blank" rel="noopener noreferrer">
                vesting details
              </a>{" "}
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to $SEVEN from the{" "}
                              {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esSEVEN deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} $SEVEN`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} $SEVEN tokens can be claimed,
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to $SEVEN from the{" "}
                              {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esSEVEN deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} $SEVEN`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} $SEVEN tokens can be claimed,
                          use the options under the Total Rewards section to claim them.
                        </Trans>
                      )}
                    />
